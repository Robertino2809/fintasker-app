...
export default function Task() {
  return (
    <div className="flex flex-col shadow-md w-full h-full border border-neutral-300 rounded-2xl p-5">
      <h1 className="text-lg mb-2 text-neutral-500">Today tasks</h1>
      <h1 className="text-3xl font-semibold">3 Tasks for today</h1>
      <div className="flex w-full h-full justify-end items-end">
        <Dialog>
          <DialogTrigger asChild>
            <Button variant="outline" className="bg-primary text-white hover:bg-secondary hover:text-white">Add new task</Button>
          </DialogTrigger>
