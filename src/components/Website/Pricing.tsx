  ...
  return (
    <div className="mb-12 lg:mb-24 relative z-10">
      ...
      <p className="text-center mx-auto max-w-lg mb-8">
        You get all features. You just need to choose how will you pay.
      </p>
...
const CTAArrow = () => (
  <div className="absolute -right-[100px] top-2 sm:top-0">
    <motion.svg
      ...
      className="scale-50 sm:scale-75 text-blue-500"
    ...
    <span className="block text-base w-fit bg-blue-500 text-white shadow px-1.5 py-0.5 rounded -mt-1 ml-8 -rotate-2 font-light italic">
      Save €
    </span>
  </div>
);
  ...
  <div className="flex flex-col lg:flex-row gap-8 lg:gap-4 w-full max-w-6xl mx-auto relative z-10">
    ...
    <div className="w-full bg-white p-6 border-[1px] border-slate-300 rounded-xl">
      ...
      <div className="flex items-center gap-2 mb-2">
        ...
        <span className="text-base">Track up to 10 tasks</span>
      </div>
      <div className="flex items-center gap-2 mb-2">
        <svg
          width="20"
        ...
        <span className="text-base">Basic task reminders</span>
      </div>
      <div className="flex items-center gap-2 mb-2">
        <svg
          width="20"
        ...
        <span className="text-base">Basic financial tracking</span>
      </div>
      <div className="flex items-center gap-2 mb-2">
        <svg
          width="20"
      ...
      <Link href={'/register'}>
        <motion.button
          ...
          className="w-full py-4 mt-8 font-semibold bg-blue-500 text-white rounded-lg"
        >
          Get started
        </motion.button>
      </Link>
    ...
    <div className="w-full bg-white p-6 border-[1px] border-slate-300 rounded-xl">
      ...
      <div className="flex items-center gap-2 mb-2">
        ...
        <span className="text-base">Track up to 50 tasks</span>
      </div>
      <div className="flex items-center gap-2 mb-2">
        <svg
          width="20"
        ...
        <span className="text-base">Detailed task reminders</span>
      </div>
      <div className="flex items-center gap-2 mb-2">
        <svg
          width="20"
        ...
        <span className="text-base">Advanced financial tracking</span>
      </div>
      <div className="flex items-center gap-2 mb-2">
        <svg
          width="20"
    ...
    <div className="w-full bg-white p-6 border-[1px] border-slate-300 rounded-xl">
      ...
      <div className="overflow-hidden mb-8">
        <AnimatePresence mode="wait">
          {selected === "M" ? (
            ...
            >
              <span>€9</span>
              <span className="font-normal text-xl">/year</span>
            </motion.p>
          ) : (
            <motion.p
              key="yearly2"
      ...
      <div className="flex items-center gap-2 mb-2">
        ...
        <span className="text-base">Unlimited tasks</span>
      </div>
      <div className="flex items-center gap-2 mb-2">
        <svg
          width="20"
        ...
        <span className="text-base">Tasks notifications and reminders</span>
      </div>
      <div className="flex items-center gap-2 mb-2">
        <svg
          width="20"
        ...
        <span className="text-base">Export data (CSV, PDF)</span>
      </div>
      <div className="flex items-center gap-2 mb-2">
        <svg
          width="20"
